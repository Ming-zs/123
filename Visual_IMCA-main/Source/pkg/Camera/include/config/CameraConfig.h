...
#define CAMERA_PARAMS "../pkg/Camera/config/armor.Config"
#endif
// 相机名
#ifndef CAMERA_NAME
#define CAMERA_NAME "A1"
#endif

#ifndef FROM_VIDEO
#define FROM_VIDEO true
#endif

#ifndef FROM_CAMERA
#define FROM_CAMERA false
#endif
// 视频源头
#ifndef VIDEO_SOURCE
...
#define ARMOR_CAMERA_EXPOSURE     (8)
#endif

#ifndef ENERGY_CAMERA_EXPOSURE
#define ENERGY_CAMERA_EXPOSURE         (1.5)
#endif
